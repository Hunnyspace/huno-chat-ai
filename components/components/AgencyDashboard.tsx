...
const AgencyDashboard: React.FC<AgencyDashboardProps> = ({ onLogout }) => {
  ...
  const [newBusiness, setNewBusiness] = useState<Omit<Business, 'businessId' | 'products'>>({
    businessName: '',
    city: '',
    businessCategory: '',
    businessInfo: '',
        ...
        <div className="max-w-7xl mx-auto">
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="glass-pane p-6 rounded-2xl flex items-center space-x-4">
                    <BuildingStorefrontIcon className="w-10 h-10 text-[var(--accent-primary)]" />
                    <div>
                ...
                <div className="glass-pane p-6 rounded-2xl flex items-center space-x-4">
                    <ChatBubbleLeftEllipsisIcon className="w-10 h-10 text-[var(--accent-primary)]" />
                    <div>
                ...
                <div className="glass-pane p-6 rounded-2xl flex items-center space-x-4">
                    <SparklesIcon className="w-10 h-10 text-[var(--accent-primary)]" />
                    <div>
